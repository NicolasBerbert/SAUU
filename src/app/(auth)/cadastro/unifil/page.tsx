    ...
    <div className="w-full max-w-md">
      <div className="mb-10">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs uppercase tracking-widest text-accent">Aluno Unifil</span>
        </div>
        <h1 className="text-3xl font-light text-primary mb-2">Criar conta</h1>
        <p className="text-sm text-muted">
          Use seu e-mail institucional <span className="text-primary">@edu.unifil.br</span>
        </p>
      </div>
